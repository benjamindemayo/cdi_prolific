...
\caption{\label{fig:wsglm}Individual children's vocabulary production scores from Dataset 1 (full Web-CDI sample) plotted by children's age and primary caregiver education level as reported in the sample of Words and Sentences Web-CDI administrations collected as of November 2020 (N = 1,900, left panel) and in the Wordbank repository (N = 2,776, right panel). Curves show generalized linear model fits.}
\end{figure}
