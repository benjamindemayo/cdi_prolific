...
\caption{\label{tab:unnamed-chunk-1}Exclusions from full Web-CDI sample}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:unnamed-chunk-8}Exclusions from recent data collection using Facebook and Prolific.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{2.4in}>{\raggedright\arraybackslash}p{1in}>{\raggedright\arraybackslash}p{1in}>{\raggedright\arraybackslash}p{1in}>{\raggedright\arraybackslash}p{1in}}
\toprule
