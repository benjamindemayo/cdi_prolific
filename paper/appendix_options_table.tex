...
\caption{(\#tab:unnamed-chunk-17)Settings customizable by researchers when creating new studies to be run on the Web-CDI platform.}\\
\toprule
\textbf{Study setting} & \textbf{Default value} & \textbf{Notes}\\
\midrule
\endfirsthead
\caption[]{(\#tab:unnamed-chunk-17)Settings customizable by researchers when creating new studies to be run on the Web-CDI platform. \textit{(continued)}}\\
\toprule
\textbf{Study setting} & \textbf{Default value} & \textbf{Notes}\\
\midrule
\endhead
...
\caption{(\#tab:unnamed-chunk-18)Regression output for WG comprehension measure.}
\centering
\resizebox{\linewidth}{!}{
...
\caption{(\#tab:unnamed-chunk-18)Regression output for WG production measure.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrrrr}
\toprule
